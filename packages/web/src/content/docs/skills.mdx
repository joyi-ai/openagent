...
- Codex global: `$CODEX_HOME/skills/<name>/SKILL.md`
...
Codex global definitions are loaded from `$CODEX_HOME/skills/*/SKILL.md` (defaults to `~/.local/share/Aura/codex` when not set).
